...
// Assuming the types have been defined as follows:
interface Image {
  imgSrc: string;
  description: string;
}
...
export async  function fetchDataImage(): Promise<DataContentList | null> {
  try {
    ...
    const data: DataContentList = await response.json();
